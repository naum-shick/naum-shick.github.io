...
function doPost(e) {
  ...
  try {
    ...
    //if (true) {
      ...
      const img = SpreadsheetApp.newCellImage().setSourceUrl(e.parameter["Signature"]).toBuilder().build();
      const newRow = [new Date(), e.parameter["Employee"], img]; // to debug add e.parameter["Signature"] 
